...
public class Config
{
    ...
    public string GetEncryptedString(string section, string key, string defaultValue = null, string password = null, bool autoLog = false, bool autoLogSuggestion = true)
    {
